...
MAKE_ARCHIVE=1
FEATURES=features # ...2
MODEL=deeplab_resnet_res1_original
...
IMAGE_SIZE=513
CLASS_COUNT=21
DATASET_DIR="${HOME}/data/pascal/all/JPEGImages/"

# Environment
CONVERTER_BIN="${HOME}/TLab-Vision-deeplab/extra/apps/inference_converter/build/install/bin/mat_to_png"
PYTHON_BIN="python"
CONVERTER_SCRIPT="./mat2png.py"
PAINTER_SCRIPT="./paint_pascal.py"
EXPER_DIR="${PWD}"
